...
function App() {
  ...
  return (
    ...
    <Routes>
        ...
        <Route path="/products/category/electronics" element={<ItemListContainer productos={productos} category="electronics"/>}/>
        <Route path="/products/category/electronics/:id"  element= {<TarjetDescription productos={productos}/>} />
        <Route path="/products/category/jewelery" element={<ItemListContainer productos={productos} category="electronics"/>}/>
        <Route path="/products/category/jewelery/:id"  element= {<TarjetDescription productos={productos}/>} />
        <Route path="/products/category/men's clothing" element={<ItemListContainer productos={productos} category="electronics"/>}/>
        <Route path="/products/category/men's clothing/:id"  element= {<TarjetDescription productos={productos}/>} />
        <Route path="/products/category/women's clothing" element={<ItemListContainer productos={productos} category="electronics"/>}/>
